...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in swarndb/v1/collection_pb2_grpc.py depends on'
...
class CollectionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateCollection = channel.unary_unary(
                '/swarndb.v1.CollectionService/CreateCollection',
                request_serializer=swarndb_dot_v1_dot_collection__pb2.CreateCollectionRequest.SerializeToString,
                response_deserializer=swarndb_dot_v1_dot_collection__pb2.CreateCollectionResponse.FromString,
                _registered_method=True)
        self.DeleteCollection = channel.unary_unary(
                '/swarndb.v1.CollectionService/DeleteCollection',
                request_serializer=swarndb_dot_v1_dot_collection__pb2.DeleteCollectionRequest.SerializeToString,
                response_deserializer=swarndb_dot_v1_dot_collection__pb2.DeleteCollectionResponse.FromString,
                _registered_method=True)
        self.GetCollection = channel.unary_unary(
                '/swarndb.v1.CollectionService/GetCollection',
                request_serializer=swarndb_dot_v1_dot_collection__pb2.GetCollectionRequest.SerializeToString,
                response_deserializer=swarndb_dot_v1_dot_collection__pb2.GetCollectionResponse.FromString,
                _registered_method=True)
...
def add_CollectionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateCollection': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=swarndb_dot_v1_dot_collection__pb2.CreateCollectionRequest.FromString,
                    response_serializer=swarndb_dot_v1_dot_collection__pb2.CreateCollectionResponse.SerializeToString,
            ),
            'DeleteCollection': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteCollection,
                    request_deserializer=swarndb_dot_v1_dot_collection__pb2.DeleteCollectionRequest.FromString,
                    response_serializer=swarndb_dot_v1_dot_collection__pb2.DeleteCollectionResponse.SerializeToString,
            ),
            'GetCollection': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCollection,
                    request_deserializer=swarndb_dot_v1_dot_collection__pb2.GetCollectionRequest.FromString,
                    response_serializer=swarndb_dot_v1_dot_collection__pb2.GetCollectionResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'swarndb.v1.CollectionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('swarndb.v1.CollectionService', rpc_method_handlers)
...
class CollectionService(object):
    ...
    def CreateCollection(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/swarndb.v1.CollectionService/CreateCollection',
            swarndb_dot_v1_dot_collection__pb2.CreateCollectionRequest.SerializeToString,
            swarndb_dot_v1_dot_collection__pb2.CreateCollectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def DeleteCollection(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/swarndb.v1.CollectionService/DeleteCollection',
            swarndb_dot_v1_dot_collection__pb2.DeleteCollectionRequest.SerializeToString,
            swarndb_dot_v1_dot_collection__pb2.DeleteCollectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetCollection(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/swarndb.v1.CollectionService/GetCollection',
            swarndb_dot_v1_dot_collection__pb2.GetCollectionRequest.SerializeToString,
            swarndb_dot_v1_dot_collection__pb2.GetCollectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
